...
namespace ProductApi.Test.Logic.ProductLogicTests
{
    public class ReserveProduct
    {
        ...
        public void ProductIdIsInvalid_ThrowArgumentException(int id)
        {
            ...
            // Act
            Assert.Throws<ArgumentException>(() => _productLogic.ReserveProduct(id, amount));
        ...
        public void RepositoryThrowsArgumentException_ThrowArgumentException()
        {
            ...
            const int id = 1;
            const int amount = 10;
            _productRepository.Setup(x => x.ReserveProduct(It.IsAny<int>(), It.IsAny<int>()))
        ...
        public void RepositoryThrowsGenericException_ThrowGenericException()
        {
            ...
            // Act
            Assert.Throws<Exception>(() => _productLogic.ReserveProduct(id, amount));
